...
/* �ϐ��̒��` */////////////////////////////////////////////////////////////////////
  $setchar='UTF-8';/*  UTF-8, Shift_JIS, EUC-JP,ISO-2022-JP */
  $pdate=$date=date("<b>Y/m/d H:i </b>");
  $lmt=100;
  $kugiri='<hr style="border:1px solid #eee">';
/* �����܂� *///////////////////////////////////////////////////////////////////////
  ...
  unset($process);}
  if(file_exists("hpcomment_store14.msg"))$comment=file_get_contents("hpcomment_store2.msg");
  ...
  file_put_contents("hpcomment_store14.msg",$comment);
